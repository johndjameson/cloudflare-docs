	...
	return (
		<>
			<button
				...
				{...getReferenceProps()}
				className="inline-flex min-h-8 min-w-32 cursor-pointer items-center justify-center gap-2 rounded-sm border border-(--sl-color-hairline) bg-transparent px-3 text-sm text-nowrap text-black hover:bg-(--sl-color-bg-nav)"
			>
				{getButtonContent()}
			</button>
			{isOpen && (
